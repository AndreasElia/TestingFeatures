...
public class Chunk extends Camera {
    ...
    public Chunk(Input input, int chunkX, int chunkY) {
        ...
        img = new BufferedImage(Globals.chunkSize * Globals.tileSize, Globals.chunkSize * Globals.tileSize,
    ...
    public void updateNeighbours(int x, int y) {
        if (x > 0 && x < (Globals.chunkSize * Globals.chunkCount) - 1 && y > 0
                && y < (Globals.chunkSize * Globals.chunkCount) - 1) {
