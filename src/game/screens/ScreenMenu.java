...
public class ScreenMenu {
	...
	public void render(Graphics g) {
		...
		g.drawString(startText, ((Main.WIDTH - g.getFontMetrics().stringWidth(startText)) / 2), startRect.y + (g.getFontMetrics().getHeight() + 9));
		...
		g.setColor(new Color(255, 255, 255));
		g.drawString(optionsText, ((Main.WIDTH - g.getFontMetrics().stringWidth(optionsText)) / 2), optionsRect.y + (g.getFontMetrics().getHeight() + 9));
		...
		g.setColor(new Color(255, 255, 255));
		g.drawString(exitText, ((Main.WIDTH - g.getFontMetrics().stringWidth(exitText)) / 2), exitRect.y + (g.getFontMetrics().getHeight() + 9));
	}
